package org.example.testhello.api
...
object TesthelloService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The testhello service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the TesthelloService.
  */
trait TesthelloService extends Service {
  ...
  override final def descriptor = {
    ...
    named("testhello")
      ...
      .withTopics(
        topic(TesthelloService.TOPIC_NAME, greetingsTopic)
